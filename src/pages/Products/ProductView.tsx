      ...
      <section className="flex flex-row">
        ...
        {product.product_image_url ? (
          <img
            ...
            className="w-[400px] outline-1 p-5 mr-[20px]"
            alt={product.title}
          />
        ) : (
          <div className="w-[100px] h-[100px] flex items-center justify-center bg-gray-200 text-gray-500 text-sm mr-[20px]">
            No Image
          </div>
        )}
        ...
        <div className="flex flex-col">
          ...
          <div className="form-control w-full max-w-xs mt-4 flex flex-row">
            ...
            <div className="flex items-center gap-2 mr-5">
              ...
              <div className="border-2 bg-white border-gray-400 rounded-lg px-6 py-1 text-center min-w-[70px] text-xl font-medium h-[40px]">
                {amount}x
              </div>
              <button
                type="button"
